...
export default function LandingPage() {
  ...
  const handleNameComplete = (name: string) => {
    setUserName(name); setShowPopup(false); trackPageVisit('landing');
  };
  ...
  return (
    <div style={{ background: '#080a0f', color: '#e8eaf0', fontFamily: "'Outfit',sans-serif", overflowX: 'hidden' }}>
      ...
      <nav style={{ position: 'fixed', top: 0, left: 0, right: 0, zIndex: 100, height: '64px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 60px', background: 'rgba(8,10,15,0.88)', backdropFilter: 'blur(20px)', borderBottom: '1px solid rgba(30,37,53,0.6)' }}>
        ...
        {/* Desktop nav links */}
        <div className="nav-desktop-links" style={{ alignItems: 'center', gap: '32px' }}>
      ...
      {/* HERO */}
      <section className="hero-section" style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '120px 60px 80px', position: 'relative', overflow: 'hidden', textAlign: 'center' }}>
      ...
      {/* PRICING */}
      <section id="pricing" className="section-pad" style={{ padding: '100px 60px', background: '#0d1018', borderTop: '1px solid #1e2535' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          ...
          <div className="price-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', border: '1px solid #1e2535', borderRadius: '16px', overflow: 'hidden' }}>
            {[
              ...
              <div key={plan.name} className="plan-card" style={{ padding: '32px 24px', background: i === 2 ? 'linear-gradient(135deg,rgba(201,168,76,0.05),rgba(126,184,247,0.02))' : '#0d1018', borderRight: i < 2 ? '1px solid #1e2535' : 'none', borderBottom: '0', position: 'relative', transition: 'transform 0.2s' }}>
      ...
      {/* FOOTER */}
      <footer className="section-pad" style={{ padding: '48px 60px 32px', borderTop: '1px solid #1e2535' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{ background: 'rgba(126,184,247,0.03)', border: '1px solid rgba(126,184,247,0.08)', borderLeft: '3px solid rgba(126,184,247,0.2)', borderRadius: '7px', padding: '12px 16px', fontSize: '0.75rem', color: '#3a4258', lineHeight: 1.6, marginBottom: '36px' }}>
          ...
          <div className="footer-inner" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingTop: '24px', borderTop: '1px solid #1e2535', flexWrap: 'wrap', gap: '12px' }}>
            ...
            <div style={{ display: 'flex', gap: '20px' }}>
              {['Privacy', 'Terms', 'Refund'].map(l => <a key={l} href="#" className="footer-link" style={{ fontSize: '0.72rem', color: '#3a4258', textDecoration: 'none' }}>{l}</a>)}
            </div>
          </div>
        </div>
      </footer>
